 ...
 */
export const getYoutubeSearchUrl = (params: YoutubeSearchParams) => {
...
export const youtubeSearch = async (
  ...
  return customFetch<YoutubeVideo[]>(getYoutubeSearchUrl(params), {
    ...options,
    method: "GET",
  });
};

export const getYoutubeSearchQueryKey = (params?: YoutubeSearchParams) => {
  return [`/api/youtube/search`, ...(params ? [params] : [])] as const;
};

export const getYoutubeSearchQueryOptions = <
  TData = Awaited<ReturnType<typeof youtubeSearch>>,
  TError = ErrorType<unknown>,
>(
  params: YoutubeSearchParams,
  options?: {
  ...
  const queryKey = queryOptions?.queryKey ?? getYoutubeSearchQueryKey(params);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof youtubeSearch>>> = ({
    signal,
  }) => youtubeSearch(params, { signal, ...requestOptions });
...
export type YoutubeSearchQueryResult = NonNullable<
  Awaited<ReturnType<typeof youtubeSearch>>
>;
export type YoutubeSearchQueryError = ErrorType<unknown>;
...
>(
  ...
  const queryOptions = getYoutubeSearchQueryOptions(params, options);
